  ...
  char * envp[])                                // environmental input to main
{
  ...
  MATRIX_DOUBLE *vlqrkf = (MATRIX_DOUBLE *)malloc(sizeof(MATRIX_DOUBLE));
  MatrixToolbox::create(vlqrkf, "vlqrkf", 0, tNpts, 1);
  MATRIX_DOUBLE *aoalqrkf = (MATRIX_DOUBLE *)malloc(sizeof(MATRIX_DOUBLE));
  MatrixToolbox::create(aoalqrkf, "aoalqrkf", 0, tNpts, 1);
  MATRIX_DOUBLE *qlqrkf = (MATRIX_DOUBLE *)malloc(sizeof(MATRIX_DOUBLE));
  MatrixToolbox::create(qlqrkf, "qlqrkf", 0, tNpts, 1);
  MATRIX_DOUBLE *omegalqrkf = (MATRIX_DOUBLE *)malloc(sizeof(MATRIX_DOUBLE));
  MatrixToolbox::create(omegalqrkf, "omegalqrkf", 0, tNpts, 1);
  MATRIX_DOUBLE *SIGvlqrkf = (MATRIX_DOUBLE *)malloc(sizeof(MATRIX_DOUBLE));
  MatrixToolbox::create(SIGvlqrkf, "SIGvlqrkf", 0, tNpts, 1);
  MATRIX_DOUBLE *SIGaoalqrkf = (MATRIX_DOUBLE *)malloc(sizeof(MATRIX_DOUBLE));
  MatrixToolbox::create(SIGaoalqrkf, "SIGaoalqrkf", 0, tNpts, 1);
  MATRIX_DOUBLE *SIGqlqrkf = (MATRIX_DOUBLE *)malloc(sizeof(MATRIX_DOUBLE));
  MatrixToolbox::create(SIGqlqrkf, "SIGqlqrkf", 0, tNpts, 1);
  MATRIX_DOUBLE *SIGomegalqrkf = (MATRIX_DOUBLE *)malloc(sizeof(MATRIX_DOUBLE));
  MatrixToolbox::create(SIGomegalqrkf, "SIGomegalqrkf", 0, tNpts, 1);

  DynamicLQR(sysGs, F, K, W, disturbance, pulseStart, pulseLength, stime, vlqr, aoalqr, qlqr, omegalqr, 
    SIGvlqr, SIGaoalqr, SIGqlqr, SIGomegalqr, vlqrkf, aoalqrkf, qlqrkf, omegalqrkf, SIGvlqrkf, SIGaoalqrkf, SIGqlqrkf, SIGomegalqrkf);

  cout << setw(19) << "time [s]" << setw(16) << "vlqr" << setw(20) << "aoalqr" << setw(22) << "qlqr" << setw(20) << "omegalqr" << setw(20) <<
    "SIGvlqr" << setw(20) << "SIGaoalqr" << setw(20) << "SIGqlqr" << setw(20) <<  "SIGomegalqr" << setw(20) << "vlqrkf" << setw(20) <<
    "aoalqrkf" << setw(22) << "qlqrkf" << setw(20) << "omegalqrkf" << setw(20) << "SIGvlqrkf" << setw(20) << "SIGaoalqrkf" << setw(20) <<
    "SIGqlqrkf" << setw(20) << "SIGomegalqrkf" << endl;
  ...
  for (int i = 0; i < tNpts; i++)
  {
    cout << "   " << setw(15) << scientific << setprecision(8) << stime->real[i][0] << setw(20) << scientific << setprecision(8) <<
      ...
      SIGqlqr->real[i][0] << setw(20) << scientific << setprecision(8) << SIGomegalqr->real[i][0] << setw(20) << scientific << setprecision(8) <<
      vlqrkf->real[i][0] << setw(20) << scientific << setprecision(8) << aoalqrkf->real[i][0] << setw(20) << scientific << setprecision(8) <<
      qlqrkf->real[i][0] << setw(20) << scientific << setprecision(8) << omegalqrkf->real[i][0] << setw(20) << scientific << setprecision(8) <<
      SIGvlqrkf->real[i][0] << setw(20) << scientific << setprecision(8) << SIGaoalqrkf->real[i][0] << setw(20) << scientific << setprecision(8) <<
      SIGqlqrkf->real[i][0] << setw(20) << scientific << setprecision(8) << SIGomegalqrkf->real[i][0] << endl;
  ...
  MatrixToolbox::destroy(vlqrkf);
  MatrixToolbox::destroy(aoalqrkf);
  MatrixToolbox::destroy(qlqrkf);
  MatrixToolbox::destroy(omegalqrkf);
  MatrixToolbox::destroy(SIGvlqrkf);
  MatrixToolbox::destroy(SIGaoalqrkf);
  MatrixToolbox::destroy(SIGqlqrkf);
  MatrixToolbox::destroy(SIGomegalqrkf);
